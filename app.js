 ...
 *
 */
var nodeTree = new NodeTree(new TextNode('First Text Node'));
 
 
app.post('/webhook', function (req, res) {
    nodeTree.handlePost(req, res);
});


function NodeTree(node) {
    this.rootNode = (node instanceof Node) ? node : null;
    
    NodeTree.prototype.handlePost = function(req, res) {
         var data = req.body;
        console.log(req);
...
function Node() {
    ...
    Node.prototype.addNode = function(node) {
        if(node instanceof Node) {
            ...
            throw new Error('Attempt to add a non-node to a Node');
        }
...
/*
function ButtonNode(arrOptions) {
    TextNode.call(this);
    this.arrOptions = arrOptions;
    
    if( !(this.arrOptions instanceof Array)) {
        throw new Error('Input to ButtonNode must be of type Array');
    }
}
ButtonNode.prototype = Object.create(TextNode().prototype);
...
function RequestReponstHandler() {
    /*
     * Authorization Event
     *
     ...
     *
     */
    RequestReponstHandler.prototype.receivedAuthentication = function(event) {
     ...
     * 
     */
    RequestReponstHandler.prototype.receivedMessage = function(event) {
      var senderID = event.sender.id;
      var recipientID = event.recipient.id;
     ...
     *
     */
    RequestReponstHandler.prototype.receivedDeliveryConfirmation = function(event) {
      var senderID = event.sender.id;
      var recipientID = event.recipient.id;
     ...
     * 
     */
    RequestReponstHandler.prototype.receivedPostback = function(event) {
      var senderID = event.sender.id;
      var recipientID = event.recipient.id;
     ...
     * 
     */
    RequestReponstHandler.prototype.receivedMessageRead = function(event) {
      var senderID = event.sender.id;
      var recipientID = event.recipient.id;
     ...
     * 
     */
    RequestReponstHandler.prototype.receivedAccountLink = function(event) {
      var senderID = event.sender.id;
      var recipientID = event.recipient.id;
    ...
    RequestReponstHandler.prototype.callSendAPI = function(messageData) {
     ...
     *
     */
    Sender.prototype.sendImageMessage = function(recipientId) {
      var messageData = {
        recipient: {
          id: recipientId
        },
     ...
     *
     */
    Sender.prototype.sendGifMessage = function(recipientId) {
      var messageData = {
        recipient: {
          id: recipientId
        },
     ...
     *
     */
    Sender.prototype.sendAudioMessage = function(recipientId) {
      var messageData = {
        recipient: {
          id: recipientId
        },
     ...
     *
     */
    Sender.prototype.sendVideoMessage = function(recipientId) {
      var messageData = {
        recipient: {
          id: recipientId
        },
     ...
     *
     */
    Sender.prototype.sendFileMessage = function(recipientId, messageData) {
      var messageData = {
        recipient: {
          id: recipientId
        },
     ...
     *
     */
    Sender.prototype.sendButtonMessage = function(recipientId, messageText, buttons) {
     ...
     *
     */
    Sender.prototype.sendGenericMessage = function(recipientId) {
      var messageData = {
        recipient: {
          id: recipientId
        },
     ...
     *
     */
    Sender.prototype.sendReceiptMessage = function(recipientId) {
     ...
     *
     */
    Sender.prototype.sendQuickReply = function(recipientId) {
      var messageData = {
        recipient: {
          id: recipientId
        },
     ...
     *
     */
    Sender.prototype.sendReadReceipt = function(recipientId) {
     ...
     *
     */
    Sender.prototype.sendTypingOn = function(recipientId) {
     ...
     *
     */
    Sender.prototype.sendTypingOff = function(recipientId) {
     ...
     *
     */
    Sender.prototype.sendAccountLinking = function(recipientId) {
      var messageData = {
        recipient: {
          id: recipientId
        },
